        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 py-12 lg:py-32 lg:pr-10'>
          <div className='lg:col-span-2 lg:col-start-4'>
            <form className='p-10 rounded bg-white shadow-sm'>
              ...
              <div className="mt-3">
                <button className="w-full text-center py-4 px-2 uppercase bg-red-500 text-white text-sm hover:bg-red-600">Sign Up</button>
              </div>
                <div className="flex items-center justify-center mt-8">
                  <span className="text-slate-400">Have an account?</span>
                  <Link to="/login" className="text-[#ee4d2d] ml-1 font-bold">Log In</Link>
                </div>
            </form>
          </div>
        </div>
