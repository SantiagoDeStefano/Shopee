...
import type { ExtendedPurchase, Purchase } from '../../types/purchase.types'
...
export default function Cart() {
  ...
  const totalCheckedPurchaseSavedPrice = useMemo(
    () =>
      checkedPurchases.reduce((result, current) => {
      ...
      <div className='max-w-7xl mx-auto px-4'>
        {extendedPurchases.length > 0 ? (
          ...
          <div className='text-center'>
            <img src={noproduct} alt='no-purchases' className='w-24 h-24 mx-auto' />
            <div className='mt-3 font-bold text-gray-600'>Your shopping cart is empty</div>
            <div className='text-center mt-8'>
              <Link
                to={path.home}
                className='rounded-xs bg-[#ee4d2d] px-9 py-3 capitalize text-white font-semibold hover:bg-[#f85c44] transition-all'
              >
                Go Shopping Now
              </Link>
            </div>
